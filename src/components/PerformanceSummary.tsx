  ...
  return (
    <section className="relative rounded-2xl p-5 mb-5 bg-zinc-900/60 ring-1 ring-white/5 overflow-hidden">
      <div
        ...
        style={{ background: "radial-gradient(ellipse at center, rgba(16,185,129,.12) 0%, rgba(16,185,129,.08) 30%, rgba(16,185,129,.04) 60%, transparent 100%)" }}
      />
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-2 flex justify-center">
            <span className="rounded-full bg-emerald-500/10 text-emerald-300 text-[13px] px-2 py-0.5">
              Silver Tier
            </span>
          </div>
